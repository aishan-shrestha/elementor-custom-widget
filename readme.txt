...
== Description ==
	- This plugin can be used as a starter boilerplate for creation of custom widget element & a sample skin named("Custom Cards Rebuild" on existing Posts widget) in elementor.
